...
bmi_edu_clean <- bmi_edu %>%
  filter(
    ...
    isced11 %in% c("ED0-2", "ED3-4", "ED5-8"), # Separate the 3 education groups
...
bmi_edu_with_var1 <- combined_dataset %>%
  mutate(
    edu_level = case_when(
      ...
      isced11 == "ED3-4" ~ "Medium Education",
...
largest_european_countries <- c("RU", "TR", "DE", "GB", "FR", "IT", "ES", "UA", "PL", "RO")
# RU:Russia, TR:Turkey, DE:Germany, GB:UnitedKingdom, FR:France, IT:Italy, ES:Spain, UA:Ukraine, PL:Poland, RO:Romania
...
selected_countries <- largest_european_countries[
  largest_european_countries %in% final_gap_data$geo
]
